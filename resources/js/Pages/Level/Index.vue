...
const submitdata = () => {
    ...
    const routeName = isUpdate ? 'level.update' : 'level.store';
    ...
    dataForm[method](route(routeName, ...routeParams), {
        onSuccess: (page) => {
            ...
            const message = isUpdate ? "Level updated successfully!" : "Level added successfully!";
...
const deletedata = (dataId) => {
    if (confirm("Are you sure you want to delete this Level?")) {
        dataForm.delete(route('level.destroy', dataId), {
            onSuccess: (page) => {
                data.value = page.props.data; // Update the data list after deletion
                ElMessage.success("level deleted successfully!");
            },
            onError: () => {
            ...
            <table class="min-w-full bg-white shadow-md rounded-lg">
                <thead>
                    <tr class="text-left">
                        ...
                        <th class="py-2 px-4 border-b-2">Level Name</th>
...
>
    <div class="modal-content">
        ...
        >
            <template #prepend>Level Name</template>
        </el-input>
